...
class AppleCredential {
    constructor(name: string, keychainPath: string, appStoreConnectKeyId: string, appStoreConnectIssuerId: string, appStoreConnectKeyPath: string, appStoreConnectKey: string, teamId: string) {
        this.name = name;
